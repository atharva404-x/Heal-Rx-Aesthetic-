...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-charcoal-950 text-ivory-100 pt-16 sm:pt-20 pb-12 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12 pb-16 border-b border-white/10">
          ...
          <div className="lg:col-span-4 space-y-4">
            <Link to="/" className="inline-block">
              <span className="font-serif text-3xl text-ivory-50">
                Heal<span className="text-gold-400 italic">Rx</span>
              </span>
              <span className="block text-[9px] uppercase tracking-widest-luxury text-gold-400 font-semibold -mt-1">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a
                ...
                className="p-2.5 rounded-full bg-charcoal-800 text-gold-400 hover:bg-gold-500 hover:text-white transition-colors"
          ...
          <div className="lg:col-span-2 space-y-4">
            <h4 className="text-xs uppercase tracking-widest-luxury text-gold-400 font-medium">
              Navigation
            </h4>
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-stone-300">
              {TREATMENTS.slice(0, 5).map(treatment => (
                <li key={treatment.slug}>
                  <Link
                    ...
                    className="hover:text-gold-300 transition-colors line-clamp-1"
                  >
                    {treatment.title}
                  </Link>
                </li>
              ...
              <li>
                <Link
                  to="/treatments"
                  className="text-gold-400 hover:text-gold-300 font-medium inline-flex items-center text-xs uppercase tracking-wider pt-1"
                >
                  View All Treatments →
                </Link>
              </li>
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="space-y-3 text-xs sm:text-sm text-stone-300">
              ...
              <div className="flex items-center space-x-2.5">
                ...
                <a href={`tel:${CLINIC_INFO.phone}`} className="hover:text-gold-300 transition-colors">
              ...
              <div className="pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block text-xs uppercase tracking-wider text-gold-400 hover:underline"
                >
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-stone-400 text-xs">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={scrollToTop}
              className="p-2 rounded-full bg-charcoal-900 text-stone-300 hover:text-white hover:bg-gold-600 transition-colors"
