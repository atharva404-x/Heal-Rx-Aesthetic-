...
export const LightboxGallery: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Editorial Grid: 1 Big Image + 3 Stacked / Layered Images */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 lg:gap-6">
        {/* Large Primary Image */}
        <div 
          onClick={() => setActiveImageIndex(0)}
          className="md:col-span-7 relative group rounded-3xl overflow-hidden aspect-[4/3] sm:aspect-[16/11] cursor-pointer shadow-luxury border border-gold-300/30"
        >
          <img
          ...
          <div className="absolute bottom-6 left-6 right-6 text-white flex items-end justify-between">
            ...
            <div className="p-3 rounded-full bg-white/20 backdrop-blur-md text-white group-hover:bg-gold-500 transition-colors">
        ...
        <div className="md:col-span-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-4 lg:gap-6">
          {CLINIC_GALLERY.slice(1, 3).map((item, idx) => (
            <div
              ...
              className="relative group rounded-3xl overflow-hidden aspect-[16/10] sm:aspect-auto sm:h-full cursor-pointer shadow-luxury border border-gold-300/30"
            >
              <img
                src={item.image}
                alt={item.title}
              ...
              <div className="absolute bottom-4 left-4 right-4 text-white flex items-end justify-between">
                ...
                <div className="p-2 rounded-full bg-white/20 backdrop-blur-md text-white group-hover:bg-gold-500 transition-colors">
      ...
      {activeImageIndex !== null && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-8 bg-charcoal-950/90 backdrop-blur-md animate-fadeIn"
          role="dialog"
          aria-modal="true"
        >
          {/* Close button */}
